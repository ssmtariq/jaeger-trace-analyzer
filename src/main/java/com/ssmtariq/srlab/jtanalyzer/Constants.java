...
public final class Constants {
    ...
    public static final String START_TIME = Utility.dateToMilliseconds("2022/09/16 16:43:00");
    public static final String END_TIME = Utility.dateToMilliseconds("2022/09/16 16:56:00");
    /* Set service name you wanna analyze */
    public static final String SERVICE_PRESERVE_OTHER = "ts-travel-plan-service";

    /* Check JaegerUI and set number of total services invoked by the intended service */
    public static final Integer NUMBER_OF_SERVICE_COUNT = 13;
